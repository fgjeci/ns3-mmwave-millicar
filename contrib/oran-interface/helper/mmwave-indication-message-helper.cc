...
// modified
void
MmWaveIndicationMessageHelper::AddCuCpUePmItem (std::string ueImsiComplete, long generatingNodeRnti,
                                                Ptr<L3RrcMeasurements> l3RrcMeasurementNeigh)
{ 

  Ptr<MeasurementItemList> ueVal = Create<MeasurementItemList> (ueImsiComplete);

  ueVal->AddItem<long> ("GeneratingNode.Rnti.UEID", generatingNodeRnti);
                                                ...
                                                Ptr<L3RrcMeasurements> l3RrcMeasurementNeigh)
{
  ...
  ueVal->AddItem<long> ("GeneratingNode.Rnti.UEID", generatingNodeRnti);
  ueVal->AddItem<long> ("GeneratingNode.PositionX.UEID", positionX);
  ueVal->AddItem<long> ("GeneratingNode.PositionY.UEID", positionY);
