...
// modified
  // const int KpmIndicationHeader::TIMESTAMP_LIMIT_SIZE;
  const int KpmIndicationHeader::TIMESTAMP_LIMIT_SIZE=8;
  // end modification
...
KpmIndicationHeader::Encode (E2SM_KPM_IndicationHeader_t *descriptor)
{
  ...
  NS_LOG_INFO (xer_fprint (stderr, &asn_DEF_E2SM_KPM_IndicationHeader, descriptor));
...
{
  NS_LOG_INFO("Entering KpmIndication encode");
  asn_codec_ctx_t *opt_cod = 0; // disable stack bounds checking
  ...
  NS_LOG_INFO("Entering KpmIndication exiting");
}
