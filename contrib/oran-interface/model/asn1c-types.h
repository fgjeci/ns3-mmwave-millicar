...
public:
  ...
  // ServingCellMeasurementsWrap (Ptr<L3RrcMeasurements> servingCellMeas);
...
public:
  ...
  void AddActivePeerDeviceSinrMcs(Ptr<ServingCellMeasurementsWrap> servingCellMeasurements, long peerDeviceId, long sinr, uint8_t mcs);

  static Ptr<MeasResultServMo>
  CreateActivePeerDeviceSinrMcs(long peerDeviceId, long sinr, uint8_t mcs);

  static Ptr<L3RrcMeasurements>
  CreateL3RrcUeSpecificPeerDevicesMeasurements();
  // end modification
