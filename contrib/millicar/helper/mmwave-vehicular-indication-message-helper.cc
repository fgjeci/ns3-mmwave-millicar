...
namespace ns3 {
  ...
  NS_LOG_COMPONENT_DEFINE("MmWaveVehicularIndicationMessageHelper");

MmWaveVehicularIndicationMessageHelper::MmWaveVehicularIndicationMessageHelper (IndicationMessageType type,
...
void
MmWaveVehicularIndicationMessageHelper::AddCuUpUePmItem (std::string ueImsiComplete,
...
void
MmWaveVehicularIndicationMessageHelper::FillCuUpValues (std::string plmId)
{
  FillBaseCuUpValues (plmId);
}

void
MmWaveVehicularIndicationMessageHelper::FillCuCpValues (uint16_t numActiveUes)
{
  FillBaseCuCpValues (numActiveUes);
}

void
MmWaveVehicularIndicationMessageHelper::FillDuValues (std::string cellObjectId)
{
...
void
MmWaveVehicularIndicationMessageHelper::AddDuUePmItem (
...
void
MmWaveVehicularIndicationMessageHelper::AddCpUePmTestItem(uint16_t rnti, long value){
  NS_LOG_FUNCTION(this << rnti<< value);
    Ptr<MeasurementItemList> ueVal = Create<MeasurementItemList> (std::to_string(rnti));
    ueVal->AddItem<long> ("Rnti", (long)rnti);
    ueVal->AddItem<long> ("Kpi", value);
    m_msgValues.m_ueIndications.insert(ueVal);
}

void
MmWaveVehicularIndicationMessageHelper::AddDuCellPmItem (
...
void
MmWaveVehicularIndicationMessageHelper::AddDuCellResRepPmItem (Ptr<CellResourceReport> cellResRep)
{
  m_duValues->m_cellResourceReportItems.insert (cellResRep);
}

void
MmWaveVehicularIndicationMessageHelper::AddCuCpUePmItem (std::string ueImsiComplete, long numDrb,
                                                long drbRelAct,
...
MmWaveVehicularIndicationMessageHelper::~MmWaveVehicularIndicationMessageHelper ()
{
}
