...
#ifndef MMWAVE_VEHICULAR_INDICATION_MESSAGE_HELPER_H
#define MMWAVE_VEHICULAR_INDICATION_MESSAGE_HELPER_H

#include <ns3/indication-message-helper.h>

namespace ns3 {

class MmWaveVehicularIndicationMessageHelper : public IndicationMessageHelper
{
public:
  MmWaveVehicularIndicationMessageHelper (IndicationMessageType type, bool isOffline, bool reducedPmValues);

  ~MmWaveVehicularIndicationMessageHelper ();
...
void AddCpUePmTestItem(uint16_t rnti, long value);
...
#endif /* MMWAVE_VEHICULAR_INDICATION_MESSAGE_HELPER_H */