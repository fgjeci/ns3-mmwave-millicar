...
#include "mmwave-vehicular-5g-helper.h"
...
#include <ns3/three-gpp-v2v-blockage-channel-condition-model.h>
#include <ns3/node-v2v-channel-condition-model.h>
...
/* ... */
NS_LOG_COMPONENT_DEFINE("MmWaveMillicarHelper");

namespace mmwave
{

NS_OBJECT_ENSURE_REGISTERED(MmWaveMillicarHelper);

MmWaveMillicarHelper::MmWaveMillicarHelper(void)
    : m_imsiCounter(0),
      m_cellIdCounter(1),
      m_harqEnabled(false),
      ...
      m_useIdealRrc(false)
{
    ...
    m_lteEnbNetDeviceFactory.SetTypeId(LteEnbNetDeviceOran::GetTypeId());
    ...
    m_phyTraceHelperMillicar = CreateObject<millicar::MmWaveVehicularTracesHelper>(); // TODO name as attribute
}
...
TypeId
MmWaveMillicarHelper::GetTypeId(void)
{
    static TypeId tid =
        TypeId("ns3::MmWaveMillicarHelper")
            .SetParent<Object>()
            .AddConstructor<MmWaveMillicarHelper>()
            .AddAttribute("PathlossModel",
                          "The type of path-loss model to be used. "
                          "The allowed values for this attributes are the type names "
                          "of any class inheriting from ns3::PropagationLossModel.",
                          StringValue("ns3::ThreeGppUmaPropagationLossModel"),
                          MakeStringAccessor(&MmWaveMillicarHelper::SetPathlossModelType),
                          MakeStringChecker())
            .AddAttribute("ChannelModel",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetChannelModelType),
                          MakeStringChecker())
            .AddAttribute("Scheduler",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetSchedulerType,
                                             &MmWaveMillicarHelper::GetSchedulerType),
                          MakeStringChecker())
            .AddAttribute("HarqEnabled",
                          "Enable Hybrid ARQ",
                          BooleanValue(true),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_harqEnabled),
                          MakeBooleanChecker())
            .AddAttribute("RlcAmEnabled",
                          "Enable RLC Acknowledged Mode",
                          BooleanValue(false),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_rlcAmEnabled),
                          MakeBooleanChecker())
            .AddAttribute("LteScheduler",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetLteSchedulerType,
                                             &MmWaveMillicarHelper::GetLteSchedulerType),
                          MakeStringChecker())
            .AddAttribute("LteFfrAlgorithm",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetLteFfrAlgorithmType,
                                             &MmWaveMillicarHelper::GetLteFfrAlgorithmType),
                          MakeStringChecker())
            .AddAttribute("LteHandoverAlgorithm",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetLteHandoverAlgorithmType,
                                             &MmWaveMillicarHelper::GetLteHandoverAlgorithmType),
                          MakeStringChecker())
            .AddAttribute("LtePathlossModel",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetLtePathlossModelType),
                          MakeStringChecker())
            .AddAttribute("BeamformingModel",
                          "The type of beamforming model to be used.",
                          StringValue("ns3::MmWaveSvdBeamforming"),
                          MakeStringAccessor(&MmWaveMillicarHelper::SetBeamformingModelType),
                          MakeStringChecker())
            .AddAttribute("UsePdschForCqiGeneration",
                        ...
                        "interference  ",
                        BooleanValue(true),
                        MakeBooleanAccessor(&MmWaveMillicarHelper::m_usePdschForCqiGeneration),
                        MakeBooleanChecker())
            .AddAttribute("AnrEnabled",
                          "Activate or deactivate Automatic Neighbour Relation function",
                          BooleanValue(true),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_isAnrEnabled),
                          MakeBooleanChecker())
            .AddAttribute("UseIdealRrc",
                          "Use Ideal or Real RRC",
                          BooleanValue(false),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_useIdealRrc),
                          MakeBooleanChecker())
            .AddAttribute("BasicCellId",
                          "The next value will be the first cellId",
                          UintegerValue(1),
                          MakeUintegerAccessor(&MmWaveMillicarHelper::m_cellIdCounter),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("BasicImsi",
                          "The next value will be the first  imsi",
                          UintegerValue(0),
                          MakeUintegerAccessor(&MmWaveMillicarHelper::m_imsiCounter),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("EnbComponentCarrierManager",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetEnbComponentCarrierManagerType,
                                             &MmWaveMillicarHelper::GetEnbComponentCarrierManagerType),
                          MakeStringChecker())
            .AddAttribute("UeComponentCarrierManager",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetUeComponentCarrierManagerType,
                                             &MmWaveMillicarHelper::GetUeComponentCarrierManagerType),
                          MakeStringChecker())
            .AddAttribute("LteEnbComponentCarrierManager",
                          ...
                          MakeStringAccessor(&MmWaveMillicarHelper::SetLteEnbComponentCarrierManagerType,
                                             &MmWaveMillicarHelper::GetLteEnbComponentCarrierManagerType),
                          MakeStringChecker())
            .AddAttribute("UseCa",
                          ...
                          BooleanValue(false),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_useCa),
                          MakeBooleanChecker())
            .AddAttribute("LteUseCa",
                          ...
                          "If false, single carrier simulation.",
                          BooleanValue(false),
                          MakeBooleanAccessor(&MmWaveMillicarHelper::m_lteUseCa),
                          MakeBooleanChecker())
            .AddAttribute("NumberOfComponentCarriers",
                          ...
                          UintegerValue(1),
                          MakeUintegerAccessor(&MmWaveMillicarHelper::m_noOfCcs),
            ...
            .AddAttribute("NumberOfLteComponentCarriers",
                            ...
                            UintegerValue(1),
                            MakeUintegerAccessor(&MmWaveMillicarHelper::m_noOfLteCcs),
                            MakeUintegerChecker<uint16_t>(MIN_NO_CC, MAX_NO_CC))
            // millicar
            .AddAttribute ("BeamformingModelMillicar",
                            "The type of beamforming model to be used.",
                            StringValue ("ns3::MmWaveSvdBeamforming"),
                            MakeStringAccessor (&MmWaveMillicarHelper::SetBeamformingModelTypeMillicar),
                            MakeStringChecker ())
            .AddAttribute ("ChannelModelTypeMillicar",
                            ...
                            MakeStringAccessor (&MmWaveMillicarHelper::SetChannelModelTypeMillicar),
                            MakeStringChecker())
            .AddAttribute ("NumerologyMillicar",
                            ...
                            UintegerValue (2),
                            MakeUintegerAccessor (&MmWaveMillicarHelper::SetNumerologyMillicar),
                            MakeUintegerChecker<uint8_t> ())
            .AddAttribute ("BandwidthMillicar",
                            "Bandwidth in Hz",
                            DoubleValue (1e8),
                            MakeDoubleAccessor (&MmWaveMillicarHelper::m_bandwidthMillicar),
                            MakeDoubleChecker<double> ())
            .AddAttribute ("SchedulingPatternOptionMillicar",
                            ...
                            EnumValue(DEFAULT),
                            MakeEnumAccessor (&MmWaveMillicarHelper::SetSchedulingPatternOptionTypeMillicar,
                                            &MmWaveMillicarHelper::GetSchedulingPatternOptionTypeMillicar),
            ...
            .AddAttribute ("E2ModeNr",
                            ...
                            BooleanValue (false),
                            MakeBooleanAccessor (&MmWaveMillicarHelper::m_e2mode_nr),
                            MakeBooleanChecker ())
            .AddAttribute ("E2ModeLte",
                            "If true, enable reporting over E2 for LTE cells.",
                            BooleanValue (false),
                            MakeBooleanAccessor (&MmWaveMillicarHelper::m_e2mode_lte),
                            MakeBooleanChecker ())
            .AddAttribute ("E2TermIp",
                            "The IP address of the RIC E2 termination",
                            StringValue ("10.244.0.240"),
                            MakeStringAccessor (&MmWaveMillicarHelper::m_e2ip),
                            MakeStringChecker ())
            .AddAttribute ("E2Port",
                            "Port number for E2",
                            UintegerValue (46422),
                            MakeUintegerAccessor (&MmWaveMillicarHelper::m_e2port),
                            MakeUintegerChecker<uint16_t> ())
            .AddAttribute ("E2LocalPort",
                            "The first port number for the local bind",
                            UintegerValue (48470),
                            MakeUintegerAccessor (&MmWaveMillicarHelper::m_e2localPort),
                            MakeUintegerChecker<uint16_t> ())        
            .AddAttribute ("TracesPath",
                            "The path where to store the path. ",
                            StringValue ("./"),
                            MakeStringAccessor (&MmWaveMillicarHelper::m_tracesPath),
                            MakeStringChecker ())
            .AddAttribute ("PlmnId",
                            ...
                            StringValue("111"),
                            MakeStringAccessor(&MmWaveMillicarHelper::m_ltePlmnId),
                            MakeStringChecker()
                        )
            ;
...
void
MmWaveMillicarHelper::DoDispose(void)
{
    NS_LOG_FUNCTION(this);
    m_channel.clear();
...
void
MmWaveMillicarHelper::DoInitialize()
{
    NS_LOG_FUNCTION(this);
    ...
    // initialize millicar part

    // intialize the RNTI counter
    m_rntiCounterMillicar = 0;
    
    // if the PHY layer configuration object was not set manually, create it 
    if (!m_phyMacConfigMillicar)
    {
        
        m_phyMacConfigMillicar = CreateObjectWithAttributes<mmwave::MmWavePhyMacCommon> ("Numerology", EnumValue (m_numerologyIndexMillicar),   
                                                                                "Bandwidth", DoubleValue (m_bandwidthMillicar));
        NS_LOG_DEBUG("Creating mac config " << m_phyMacConfigMillicar);
    }

    m_channelMillicar = CreateSpectrumChannelMillicar (m_channelModelTypeMillicar);
...
Ptr<SpectrumChannel>
MmWaveMillicarHelper::CreateSpectrumChannelMillicar (std::string channelModelType) const
{  
    NS_LOG_FUNCTION(this);
  Ptr<SpectrumChannel> channel = CreateObject<MultiModelSpectrumChannel> ();
  if (channelModelType == "V2V-Urban")
  {
    NS_LOG_DEBUG("COnfiguring V2VUrban");
    // original
    // Ptr<ChannelConditionModel> ccm = CreateObject<ThreeGppV2vUrbanChannelConditionModel> ();
    // modified
    Ptr<ThreeGppV2vUrbanBlockageChannelConditionModel> v2vBlockageChannel = CreateObject<ThreeGppV2vUrbanBlockageChannelConditionModel> ();
    // Ptr<NodeV2vChannelConditionModel> nodeV2VChannelCondition = CreateObject<NodeV2vChannelConditionModel> ();
    // v2vBlockageChannel->SetV2vChannelConditionModel(nodeV2VChannelCondition);
    Ptr<ChannelConditionModel> ccm = DynamicCast<ChannelConditionModel>(v2vBlockageChannel);
    // end modification
    
    Ptr<ThreeGppPropagationLossModel> plm = CreateObject<ThreeGppV2vUrbanPropagationLossModel> ();
    plm->SetChannelConditionModel (ccm);
    plm->SetFrequency (m_phyMacConfigMillicar->GetCenterFrequency());
    ...
    splm->SetChannelModelAttribute ("Frequency", DoubleValue(m_phyMacConfigMillicar->GetCenterFrequency()));
    splm->SetChannelModelAttribute ("Scenario", StringValue ("V2V-Urban"));
    NS_LOG_DEBUG("Central frequency " << m_phyMacConfigMillicar->GetCenterFrequency());
...
void
MmWaveMillicarHelper::SetConfigurationParametersMillicar (Ptr<mmwave::MmWavePhyMacCommon> conf)
{
  NS_LOG_FUNCTION (this);
  NS_ASSERT_MSG (m_rntiCounterMillicar == 0, "The PHY configuration should be set before the installation of any device.");
  m_phyMacConfigMillicar = conf;
}

Ptr<mmwave::MmWavePhyMacCommon>
MmWaveMillicarHelper::GetConfigurationParametersMillicar () const
{
  NS_LOG_FUNCTION (this);
  return m_phyMacConfigMillicar;
}


void
MmWaveMillicarHelper::SetNumerologyMillicar (uint8_t index)
{
  NS_LOG_FUNCTION (this);
  m_numerologyIndexMillicar = index;
}

void
MmWaveMillicarHelper::SetChannelModelTypeMillicar (std::string model)
{
  NS_LOG_FUNCTION (this);
  m_channelModelTypeMillicar = model;
}

void
MmWaveMillicarHelper::RegisterMillicarDevicesToEnb(NetDeviceContainer ueNetDevices, Ptr<MmWaveEnbNetDevice> enbNetDevice){

    // enbNetDevice
    for (NetDeviceContainer::Iterator i = ueNetDevices.Begin (); i != ueNetDevices.End (); ++i)
    {
        Ptr<MmWaveMillicarUeNetDevice> ueDev = DynamicCast<MmWaveMillicarUeNetDevice>((*i));
        if(ueDev != nullptr){
            uint16_t millicarRnti = ueDev->GetMacMillicar()->GetRnti();
            enbNetDevice->AddMillicarDevice(millicarRnti, ueDev);
        }
    }
...
NetDeviceContainer
MmWaveMillicarHelper::InstallMmWaveVehicularNetDevicesMillicar (NodeContainer nodes)
{
  NS_LOG_FUNCTION (this);
  ...
  for (NodeContainer::Iterator i = nodes.Begin (); i != nodes.End (); ++i)
    {
      ...
      // create the device
      Ptr<MmWaveMillicarUeNetDevice> device = InstallSingleMmWaveVehicularNetDeviceMillicar (node, ++m_rntiCounterMillicar);
...
Ptr<MmWaveMillicarUeNetDevice>
MmWaveMillicarHelper::InstallSingleMmWaveVehicularNetDeviceMillicar (Ptr<Node> node, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
  ...
  Ptr<millicar::MmWaveSidelinkSpectrumPhy> ssp = CreateObject<millicar::MmWaveSidelinkSpectrumPhy> ();
  NS_ASSERT_MSG (node->GetObject<MobilityModel> (), "Missing mobility model");
  ssp->SetMobility (node->GetObject<MobilityModel> ());
  NS_ASSERT_MSG (m_channelMillicar, "First create the channel");
  ssp->SetChannel (m_channelMillicar);
  ssp->SetAntenna (aam);

  // create the phy
  NS_ASSERT_MSG (m_phyMacConfigMillicar, "First set the configuration parameters");
  Ptr<millicar::MmWaveSidelinkPhy> phy = CreateObject<millicar::MmWaveSidelinkPhy> (ssp, m_phyMacConfigMillicar);

  // add the spectrum phy to the spectrum channel
  m_channelMillicar->AddRx (ssp);

  // create and configure the chunk processor
  Ptr<mmwave::mmWaveChunkProcessor> pData = Create<mmwave::mmWaveChunkProcessor> ();
  pData->AddCallback (MakeCallback (&millicar::MmWaveSidelinkSpectrumPhy::UpdateSinrPerceived, ssp));
  ssp->AddDataSinrChunkProcessor (pData);


  // connect the rx callback of the spectrum object to the sink
  ssp->SetPhyRxDataEndOkCallback (MakeCallback (&millicar::MmWaveSidelinkPhy::Receive, phy));

  // connect the callback to report the SINR
  ssp->SetSidelinkSinrReportCallback (MakeCallback (&millicar::MmWaveSidelinkPhy::GenerateSinrReport, phy));

  if(m_phyTraceHelperMillicar)
  {
    ssp->SetSidelinkSinrReportCallback (MakeCallback (&millicar::MmWaveVehicularTracesHelper::McsSinrCallback, m_phyTraceHelperMillicar));
    // to have info on the rnti as well
    // ssp->SetSidelinkSinrReportCallback (MakeCallback (&millicar::MmWaveVehicularTracesHelper::McsSinrCallbackPerDevice, m_phyTraceHelperMillicar));
  }

  // create the mac
  Ptr<millicar::MmWaveSidelinkMac> mac = CreateObject<millicar::MmWaveSidelinkMac> (m_phyMacConfigMillicar);
  mac->SetRnti (rnti);
  phy->SetRnti (rnti);
  ...
  Ptr<MmWaveMillicarUeNetDevice> device = CreateObject<MmWaveMillicarUeNetDevice> (phy, mac);
  device->SetAttribute("PhyTraceHelperMillicar", PointerValue(m_phyTraceHelperMillicar));
  device->SetAntennaArrayMillicar (aam);
...
//   mac->SetAttributeFailSafe ("Device", PointerValue (device));
    ...
    // phy->SetMillicarSinrMapReportCallback(MakeCallback(&MmWaveMillicarUeNetDevice::MillicarSinrMapReport, device));

  // initialize the channel (if needed)
  Ptr<ThreeGppSpectrumPropagationLossModel> splm = DynamicCast<ThreeGppSpectrumPropagationLossModel> (m_channelMillicar->GetPhasedArraySpectrumPropagationLossModel ());
  auto channelModel = splm->GetChannelModel();  
  Ptr<mmwave::MmWaveBeamformingModel> bfModel = m_bfModelFactoryMillicar.Create<mmwave::MmWaveBeamformingModel> ();
  ...
  // set the spectrum propagation loss model
  phy->SetSpectrumPropagationLossModel(splm);

  // add propagation loss model -> which is missing to calculate snr
  phy->SetPropagationLossModel(m_channelMillicar->GetPropagationLossModel());
  
  return device;
}

void
MmWaveMillicarHelper::PairDevicesMillicar (NetDeviceContainer devices)
{
  NS_LOG_FUNCTION (this);
  ...
  std::vector<uint16_t> pattern = CreateSchedulingPatternMillicar(devices);
  ...
  for (NetDeviceContainer::Iterator i = devices.Begin (); i != devices.End (); ++i)
    {
      ...
      Ptr<MmWaveMillicarUeNetDevice> di = DynamicCast<MmWaveMillicarUeNetDevice> (*i);
      ...
      di->GetMacMillicar ()->SetSfAllocationInfo (pattern); // this is called ONCE for each NetDevice

    // set local device
    di->GetPhyMillicar ()-> SetDevice(di);

      for (NetDeviceContainer::Iterator j = i + 1; j != devices.End (); ++j)
      {
        Ptr<MmWaveMillicarUeNetDevice> dj = DynamicCast<MmWaveMillicarUeNetDevice> (*j);
        ...
        di->GetPhyMillicar ()->AddDevice (dj->GetMacMillicar ()->GetRnti (), dj);
        dj->GetPhyMillicar ()->AddDevice (di->GetMacMillicar ()->GetRnti (), di);
        ...
        NS_LOG_DEBUG("Bearer ID: " << uint32_t(bearerId) << " - Associate RNTI " << di->GetMacMillicar ()->GetRnti () << " to " << dj->GetMacMillicar ()->GetRnti ());

        di->ActivateBearerMillicar(bearerId, dj->GetMacMillicar ()->GetRnti (), djAddr);
        dj->ActivateBearerMillicar(bearerId, di->GetMacMillicar ()->GetRnti (), diAddr);
        bearerId++;
      }
...
std::vector<uint16_t>
MmWaveMillicarHelper::CreateSchedulingPatternMillicar (NetDeviceContainer devices)
{
    NS_LOG_DEBUG("Slots per subframe " << m_phyMacConfigMillicar->GetSlotsPerSubframe ());
  ...
  NS_ABORT_MSG_IF (devices.GetN () > m_phyMacConfigMillicar->GetSlotsPerSubframe (), "Too many devices");

  // NOTE fixed scheduling pattern, set in configuration time and assumed the same for each subframe

  uint8_t slotPerSf = m_phyMacConfigMillicar->GetSlotsPerSubframe ();
  std::vector<uint16_t> pattern;

  switch (m_schedulingOptMillicar)
  {
    case DEFAULT:
    {
      ...
      {
        Ptr<MmWaveMillicarUeNetDevice> di = DynamicCast<MmWaveMillicarUeNetDevice> (devices.Get (i));
        pattern.at(i) = di->GetMacMillicar ()->GetRnti ();
        NS_LOG_DEBUG ("slot " << i << " assigned to rnti " << di->GetMacMillicar ()->GetRnti ());
      }
      break;
    }
    case OPTIMIZED:
    {
      ...
      for (uint16_t i = 0; i < devices.GetN (); i++)
      {
        ...
        {
          pattern.push_back(di->GetMacMillicar ()->GetRnti ());
          NS_LOG_DEBUG ("slot " << uint16_t(slotCnt) << " assigned to rnti " << di->GetMacMillicar ()->GetRnti ());
          slotCnt++;
        }
      }
...
void
MmWaveMillicarHelper::SetBeamformingModelTypeMillicar (std::string type)
{
  NS_LOG_FUNCTION (this << type);
  m_bfModelFactoryMillicar = ObjectFactory (type);
}

void
MmWaveMillicarHelper::SetSchedulingPatternOptionTypeMillicar (SchedulingPatternOption_t spo)
{
  NS_LOG_FUNCTION (this);
  m_schedulingOptMillicar = spo;
}

MmWaveMillicarHelper::SchedulingPatternOption_t
MmWaveMillicarHelper::GetSchedulingPatternOptionTypeMillicar () const
{
  NS_LOG_FUNCTION (this);
  return m_schedulingOptMillicar;
}
...
void
MmWaveMillicarHelper::MmWaveChannelModelInitialization(void)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::LteChannelModelInitialization(void)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetLtePathlossModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetUeBeamformingCodebookType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
    if (!type.empty())
    {
...
void
MmWaveMillicarHelper::SetEnbBeamformingCodebookType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
    if (!type.empty())
    {
...
void
MmWaveMillicarHelper::SetBeamformingModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetChannelConditionModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetPathlossModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
MmWaveMillicarHelper::GetPathLossModel(uint8_t index)
{
...
void
MmWaveMillicarHelper::SetChannelModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetChannelModelAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetMmWaveEnbNetDeviceAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetMmWaveUeNetDeviceAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetMcUeNetDeviceAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetUeBeamformingCodebookAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetEnbBeamformingCodebookAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetBeamformingModelAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetUePhasedArrayModelAttribute(std::string name, const AttributeValue& value)
{
...
void
MmWaveMillicarHelper::SetEnbPhasedArrayModelAttribute(std::string name, const AttributeValue& value)
{
    NS_LOG_FUNCTION(this << name);
...
void
MmWaveMillicarHelper::SetSchedulerType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
std::string
MmWaveMillicarHelper::GetSchedulerType() const
{
    return m_schedulerFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetLteSchedulerType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
std::string
MmWaveMillicarHelper::GetLteSchedulerType() const
{
    return m_lteSchedulerFactory.GetTypeId().GetName();
}

std::string
MmWaveMillicarHelper::GetLteFfrAlgorithmType() const
{
    return m_lteFfrAlgorithmFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetLteFfrAlgorithmType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
std::string
MmWaveMillicarHelper::GetLteHandoverAlgorithmType() const
{
    return m_lteHandoverAlgorithmFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetLteHandoverAlgorithmType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetUePhasedArrayModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetEnbPhasedArrayModelType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
void
MmWaveMillicarHelper::SetHarqEnabled(bool harqEnabled)
{
    m_harqEnabled = harqEnabled;
}

bool
MmWaveMillicarHelper::GetHarqEnabled()
{
    return m_harqEnabled;
}

void
MmWaveMillicarHelper::SetSnrTest(bool snrTest)
{
    m_snrTest = snrTest;
}

bool
MmWaveMillicarHelper::GetSnrTest()
{
    return m_snrTest;
}

void
MmWaveMillicarHelper::SetCcPhyParams(std::map<uint8_t, MmWaveComponentCarrier> ccMapParams)
{
    NS_LOG_FUNCTION(this);
...
MmWaveMillicarHelper::GetCcPhyParams()
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::SetLteCcPhyParams(std::map<uint8_t, ComponentCarrier> ccMapParams)
{
    NS_LOG_FUNCTION(this);
...
NetDeviceContainer
MmWaveMillicarHelper::InstallUeDevice(NodeContainer c)
{
    NS_LOG_FUNCTION(this);
    Initialize(); // Run DoInitialize (), if necessary
    NetDeviceContainer devices;
    ...
    {
        Ptr<Node> node = *i;
        Ptr<NetDevice> device = InstallSingleUeDevice(node, ++m_rntiCounterMillicar);
        device->SetAddress(Mac64Address::Allocate());
        devices.Add(device);
    }
    return devices;
...
NetDeviceContainer
MmWaveMillicarHelper::InstallMcUeDevice(NodeContainer c)
{
    NS_LOG_FUNCTION(this);
    Initialize(); // Run DoInitialize (), if necessary
    NetDeviceContainer devices;
    ...
    {
        Ptr<Node> node = *i;
        Ptr<NetDevice> device = InstallSingleMcUeDevice(node, ++m_rntiCounterMillicar);
        device->SetAddress(Mac64Address::Allocate());
        devices.Add(device);
    }
    return devices;
...
NetDeviceContainer
MmWaveMillicarHelper::InstallInterRatHoCapableUeDevice(NodeContainer c)
{
    NS_LOG_FUNCTION(this);
    Initialize(); // Run DoInitialize (), if necessary
    NetDeviceContainer devices;
...
NetDeviceContainer
MmWaveMillicarHelper::InstallEnbDevice(NodeContainer c)
{
    NS_LOG_FUNCTION(this);
    Initialize(); // Run DoInitialize (), if necessary
    NetDeviceContainer devices;
...
NetDeviceContainer
MmWaveMillicarHelper::InstallLteEnbDevice(NodeContainer c)
{
    NS_LOG_FUNCTION(this);
    Initialize(); // Run DoInitialize (), if necessary
    NetDeviceContainer devices;
...
Ptr<NetDevice>
MmWaveMillicarHelper::InstallSingleMcUeDevice(Ptr<Node> n, uint16_t millicarRnti)
{
    NS_LOG_FUNCTION(this);
...
Ptr<NetDevice>
MmWaveMillicarHelper::InstallSingleInterRatHoCapableUeDevice(Ptr<Node> n)
{
    NS_LOG_FUNCTION(this);
    ...
    MmWaveMillicarHelper::InstallUeDevice ()"); mmWaveUlPhy->SetMobility(mm); mmWaveDlPhy->SetMobility(mm);
...
Ptr<NetDevice>
MmWaveMillicarHelper::InstallSingleUeDevice(Ptr<Node> n, uint16_t millicarRnti)
{
    NS_LOG_FUNCTION(this);
    ...
    // device->SetNode(n);
    Ptr<MmWaveMillicarUeNetDevice> device = InstallSingleMmWaveVehicularNetDeviceMillicar(n, millicarRnti);
    ...
    // adding the callback when receiving a E2 message
    // connect callback from rrc to enb dev
    rrc->SetE2MEssageRelayCallback(MakeCallback(&MmWaveMillicarUeNetDevice::ProcessE2Message, device));
    
    nas->SetDevice(device);

    n->AddDevice(device);

    nas->SetForwardUpCallback(MakeCallback(&MmWaveMillicarUeNetDevice::ReceiveMillicar, device));
    ...
    NS_LOG_DEBUG("Initializing millicar device");
    device->Initialize();
...
// MmWaveMillicarHelper::ReceiveE2Msg(Ptr<const Packet> packet, uint16_t protocolNumber, const Address& sender){
...
Ptr<NetDevice>
MmWaveMillicarHelper::InstallSingleEnbDevice(Ptr<Node> n)
{
    ...
    for (auto it = ccMap.begin(); it != ccMap.end(); ++it)
    {
        ...
        NS_ASSERT_MSG(mm,
                      ...
                      "MmWaveMillicarHelper::InstallEnbDevice ()");
        ulPhy->SetMobility(mm);
        dlPhy->SetMobility(mm);
  ...
  */
    ...
    // connect callback from rrc to enb dev
    rrc->SetE2MEssageRelayCallback(MakeCallback(&MmWaveEnbNetDevice::ForwardE2Message, device));
    // RIC connection
    if(m_e2mode_nr) {
        ...
        NS_LOG_INFO ("Real cell id " << cellId <<  " cell_id " << gnb_id);
...
Ptr<NetDevice>
MmWaveMillicarHelper::InstallSingleLteEnbDevice(Ptr<Node> n)
{
    uint16_t cellId = m_cellIdCounter; // \todo Remove, eNB has no cell ID

    Ptr<LteEnbNetDeviceOran> dev = m_lteEnbNetDeviceFactory.Create<LteEnbNetDeviceOran>();
    ...
    rrc->SetForwardUpCallback(MakeCallback(&LteEnbNetDeviceOran::Receive, dev));
...
void
MmWaveMillicarHelper::AttachToClosestEnb(NetDeviceContainer ueDevices, NetDeviceContainer enbDevices)
{
    NS_LOG_FUNCTION(this);
...
// for MC devices
void
MmWaveMillicarHelper::AttachToClosestEnb(NetDeviceContainer ueDevices,
...
void
MmWaveMillicarHelper::AttachIrToClosestEnb(NetDeviceContainer ueDevices,
                                   NetDeviceContainer mmWaveEnbDevices,
                                   NetDeviceContainer lteEnbDevices)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::AttachToClosestEnb(Ptr<NetDevice> ueDevice, NetDeviceContainer enbDevices)
{
...
void
MmWaveMillicarHelper::AttachMcToClosestEnb(Ptr<NetDevice> ueDevice,
                                   NetDeviceContainer mmWaveEnbDevices,
                                   NetDeviceContainer lteEnbDevices)
{
    NS_LOG_FUNCTION(this);
    ...
    NS_ASSERT(lteClosestEnbDevice->GetObject<LteEnbNetDeviceOran>()); // stop if it is not an LTE eNB
    ...
    mcDevice->SetLteTargetEnb(DynamicCast<LteEnbNetDevice>(enbLteDevice));
}

void
MmWaveMillicarHelper::AttachIrToClosestEnb(Ptr<NetDevice> ueDevice,
                                   NetDeviceContainer mmWaveEnbDevices,
                                   NetDeviceContainer lteEnbDevices)
{
    NS_LOG_FUNCTION(this);
    ...
    for (NetDeviceContainer::Iterator i = lteEnbDevices.Begin(); i != lteEnbDevices.End(); ++i)
    {
        Ptr<LteEnbNetDeviceOran> lteEnb = (*i)->GetObject<LteEnbNetDeviceOran>();
    ...
    Ptr<LteEnbNetDeviceOran> enbLteDevice = lteClosestEnbDevice->GetObject<LteEnbNetDeviceOran>();
    Ptr<EpcUeNas> lteUeNas = mcDevice->GetNas();
    lteUeNas->Connect(enbLteDevice->GetCellId(),
...
void
MmWaveMillicarHelper::AttachToEnbWithIndex(Ptr<NetDevice> ueDevice,
                                   ...
                                   uint32_t index)
{
    ...
    Ptr<MmWaveMillicarUeNetDevice> mmWaveUe = ueDevice->GetObject<MmWaveMillicarUeNetDevice>();
    ...
    targetEnbDevice->GetObject<MmWaveEnbNetDevice>()->GetPhy()->AddUePhy(
        ueDevice->GetObject<MmWaveMillicarUeNetDevice>()->GetImsi(),
        ueDevice);
    ueDevice->GetObject<MmWaveMillicarUeNetDevice>()->GetPhy()->RegisterToEnb(cellId, configParams);
    targetEnbDevice->GetObject<MmWaveEnbNetDevice>()->GetMac()->AssociateUeMAC(
        ueDevice->GetObject<MmWaveMillicarUeNetDevice>()->GetImsi());

    // connect to the target one
    Ptr<EpcUeNas> ueNas = ueDevice->GetObject<MmWaveMillicarUeNetDevice>()->GetNas();
    ...
    // if (m_epcHelper == 0)
    //{
    ueDevice->GetObject<MmWaveMillicarUeNetDevice>()->SetTargetEnb(
        targetEnbDevice->GetObject<MmWaveEnbNetDevice>());
    //}
}

void
MmWaveMillicarHelper::AddX2Interface(NodeContainer enbNodes)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::AddX2Interface(Ptr<Node> enbNode1, Ptr<Node> enbNode2)
{
    NS_LOG_FUNCTION(this);
...
void
MmWaveMillicarHelper::AddX2Interface(NodeContainer lteEnbNodes, NodeContainer mmWaveEnbNodes)
{
    NS_LOG_FUNCTION(this);
    ...
    for (NodeContainer::Iterator i = mmWaveEnbNodes.Begin(); i != mmWaveEnbNodes.End(); ++i)
    {
        ...
        Ptr<LteEnbNetDeviceOran> closestEnbDevice =
            closestLteNode->GetDevice(0)->GetObject<LteEnbNetDeviceOran>();
        if (closestEnbDevice)
        {
...
void
MmWaveMillicarHelper::SetEpcHelper(Ptr<EpcHelper> epcHelper)
{
...
void
MmWaveMillicarHelper::ActivateDataRadioBearer(NetDeviceContainer ueDevices, EpsBearer bearer)
{
    NS_LOG_FUNCTION(this);
    for (NetDeviceContainer::Iterator i = ueDevices.Begin(); i != ueDevices.End(); ++i)
    {
...
void
MmWaveMillicarHelper::ActivateDataRadioBearer(Ptr<NetDevice> ueDevice, EpsBearer bearer)
{
...
void
MmWaveMillicarHelper::EnableTraces(void)
{
    // EnableDlPhyTrace();
    // EnableUlPhyTrace();
    // EnableEnbSchedTrace();
...
void
MmWaveMillicarHelper::EnableEnbSchedTrace()
{
...
void
MmWaveMillicarHelper::EnableDlPhyTrace(void)
{
...
void
MmWaveMillicarHelper::EnableUlPhyTrace(void)
{
    NS_LOG_FUNCTION_NOARGS();
    Config::ConnectWithoutContextFailSafe(
...
void
MmWaveMillicarHelper::EnableTransportBlockTrace()
{
    NS_LOG_FUNCTION_NOARGS();
    Config::ConnectFailSafe(
...
void
MmWaveMillicarHelper::EnableRlcTraces(void)
{
    NS_ASSERT_MSG(!m_rlcStats,
                  "please make sure that MmWaveMillicarHelper::EnableRlcTraces is called at most once");
    m_rlcStats = CreateObject<MmWaveBearerStatsCalculator>("RLC");
    // modified
    // adding the output dir where to store the data
    m_rlcStats->SetAttribute("DlRlcOutputFilename", StringValue(m_tracesPath + "DlRlcStats.txt")); 
    m_rlcStats->SetAttribute("UlRlcOutputFilename", StringValue(m_tracesPath + "UlRlcStats.txt")); 
    m_rlcStats->SetAttribute("GnbRlcBufferSizeOutputFilename", StringValue(m_tracesPath + "GnbRlcBufferSizeStats.txt"));
    m_rlcStats->SetAttribute("UeRlcBufferSizeOutputFilename", StringValue(m_tracesPath + "UeRlcBufferSizeStats.txt"));
    
    m_rlcStats->SetAttribute("AggregatedStats", BooleanValue(false)); 
    // end modification
    m_radioBearerStatsConnector->EnableRlcStats(m_rlcStats);
}

Ptr<MmWaveBearerStatsCalculator>
MmWaveMillicarHelper::GetRlcStats(void)
{
    return m_rlcStats;
}

void
MmWaveMillicarHelper::EnablePdcpTraces(void)
{
    NS_ASSERT_MSG(!m_pdcpStats,
                  "please make sure that MmWaveMillicarHelper::EnablePdcpTraces is called at most once");
    m_pdcpStats = CreateObject<MmWaveBearerStatsCalculator>("PDCP");
    // modified
    m_pdcpStats->SetAttribute("DlPdcpOutputFilename", StringValue(m_tracesPath + "MmwaveDlPdcpStats.txt")); 
    m_pdcpStats->SetAttribute("UlPdcpOutputFilename", StringValue(m_tracesPath + "MmwaveUlPdcpStats.txt")); 
    m_pdcpStats->SetAttribute("GnbRlcBufferSizeOutputFilename", StringValue(m_tracesPath + "GnbRlcBufferSizeStats.txt"));
    m_pdcpStats->SetAttribute("UeRlcBufferSizeOutputFilename", StringValue(m_tracesPath + "UeRlcBufferSizeStats.txt"));
    // end modification
    m_radioBearerStatsConnector->EnablePdcpStats(m_pdcpStats);
}

Ptr<MmWaveBearerStatsCalculator>
MmWaveMillicarHelper::GetPdcpStats(void)
{
    return m_pdcpStats;
}

void
MmWaveMillicarHelper::EnableMcTraces(void)
{
    NS_ASSERT_MSG(!m_mcStats,
                  "please make sure that MmWaveMillicarHelper::EnableMcTraces is called at most once");
    m_mcStats = CreateObject<McStatsCalculator>();
    m_radioBearerStatsConnector->EnableMcStats(m_mcStats);
}

Ptr<McStatsCalculator>
MmWaveMillicarHelper::GetMcStats(void)
{
    return m_mcStats;
}

std::string
MmWaveMillicarHelper::GetEnbComponentCarrierManagerType() const
{
    return m_enbComponentCarrierManagerFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetEnbComponentCarrierManagerType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
std::string
MmWaveMillicarHelper::GetLteEnbComponentCarrierManagerType() const
{
    return m_lteEnbComponentCarrierManagerFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetLteEnbComponentCarrierManagerType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
...
std::string
MmWaveMillicarHelper::GetUeComponentCarrierManagerType() const
{
    return m_ueComponentCarrierManagerFactory.GetTypeId().GetName();
}

void
MmWaveMillicarHelper::SetUeComponentCarrierManagerType(std::string type)
{
    NS_LOG_FUNCTION(this << type);
