...
public:
  ...
  /**
   * Function hooked to state transition trace source at UE RRC,
   */
  static void NotifyUeRrcStateTransition (MmWaveBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti, LteUeRrc::State oldState, LteUeRrc::State newState);

  static void NotifyEnbRrcStateTransition (MmWaveBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti, UeManager::State oldState, UeManager::State newState);
  ...
  std::string GetEnbRrcStateTransitionFileName(void);
  std::string GetUeRrcStateTransitionFileName(void);
  ...
  void SetEnbRrcStateTransitionFileName(std::string outputFilename);
  void SetUeRrcStateTransitionFileName(std::string outputFilename);
...
static const std::string& gnbToStringState(UeManager::State s)
{
  ...
  void SwitchStateUe(uint64_t imsi, uint16_t cellId, uint16_t rnti, LteUeRrc::State oldState, LteUeRrc::State newState);
  void SwitchStateEnb(uint64_t imsi, uint16_t cellId, uint16_t rnti, UeManager::State oldState, UeManager::State newState);
  ...
  std::string m_enbRrcStateFileName;
  std::string m_ueRrcStateFileName;
  ...
  std::ofstream m_enbRrcStateFile;
